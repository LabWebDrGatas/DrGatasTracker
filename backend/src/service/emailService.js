...
module.exports = {
    sendEmail: async(message, subject, to) => {
        let emailOptions = {
            ...
            to: to, //HERE WOULD BE THE USER EMAIL AFTER THE CREDENTIALS ARE GENERATED DO NOT CHANGE
            subject: subject,
            html: `
            ...
            * {
            ...
            <!--[if (mso)|(IE)]><td align="center" width="650" style="background-color: #f3f3f3;width: 650px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="padding-right: 0px;padding-left: 0px;" align="center">
                  ...
                  <img align="center" border="0" src="https://scontent.fntr1-1.fna.fbcdn.net/v/t1.6435-9/94483180_884787575318409_8513623928072044544_n.png?_nc_cat=111&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=C0pbSv2HyfkAX_yQqsm&_nc_ht=scontent.fntr1-1.fna&oh=3b4939a0a45d3c3dc48f984186b92f92&oe=61BB86F6" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 24%;max-width: 156px;" width="156"/>
            ...
            <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #0099ff; line-height: 170%; text-align: left; word-wrap: break-word;">
                <p style="line-height: 170%; text-align: center; font-size: 14px;"><span style="font-size: 24px; line-height: 40.8px;"><strong>Tu orden ha sido generada</strong></span></p>
            <p style="line-height: 170%; text-align: center; font-size: 14px;"><span style="font-size: 20px; line-height: 34px;">C&oacute;digo de rastreo ${message}</span></p>
              </div>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="padding-right: 0px;padding-left: 0px;" align="center">
                  ...
                  <img align="center" border="0" src="https://www.jeanstrack.com/blog/wp-content/uploads/2019/10/Leyre-Soriano-Pantalon-Tardor-verde-1-1024x683.jpg" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 650px;" width="650"/>
            ...
            <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #1b262c; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;"><strong><span style="font-size: 26px; line-height: 36.4px;">Verifica en las pr&oacute;ximas horas su estado</span></strong></p>
              </div>
            ...
            <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #1b262c; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 16px; line-height: 22.4px;">Tu orden est&aacute; pendiente de revisi&oacute;n y ser&aacute; aceptada dependiendo de la cantidad de trabajo actual y el estado de tus zapatos.</span></p>
              </div>
            ...
            <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #5f5f5f; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;">Tu informaci&oacute;n est&aacute; protegida.</p>
              </div>
            ...
            <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">Copyright dr Gatas | Todos los derechos resevados</span></p>
              </div>
    ...
    sendEmailUpdate: async(message, subject, to) => {
      let emailOptions = {
          from: 'Dr Gatas <robot@drgatas.com>',
          to: to, //HERE WOULD BE THE USER EMAIL AFTER THE CREDENTIALS ARE GENERATED DO NOT CHANGE
          subject: subject,
          ...
          * {
          ...
          <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <div style="color: #0099ff; line-height: 170%; text-align: left; word-wrap: break-word;">
              <p style="line-height: 170%; text-align: center; font-size: 14px;"><span style="font-size: 24px; line-height: 40.8px;"><strong>Tu pedido ahora se encuentra en estado: ${message.estado} </strong></span></p>
          <p style="line-height: 170%; text-align: center; font-size: 14px;"><span style="font-size: 20px; line-height: 34px;">C&oacute;digo de rastreo ${message.numRastreo}</span></p>
            </div>
  ...
  sendEmailReady: async(message, subject, urlImg, to) => {
    let emailOptions = {
        from: 'Dr Gatas <robot@drgatas.com>',
        ...
        * {
        ...
        <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #0099ff; line-height: 170%; text-align: left; word-wrap: break-word;">
            <p style="line-height: 170%; text-align: center; font-size: 14px;"><span style="font-size: 24px; line-height: 40.8px;"><strong>Ya puedes recoger tu pedido${message.numRastreo} </strong></span></p>
        <p style="line-height: 170%; text-align: center; font-size: 14px;"><span style="font-size: 20px; line-height: 34px;">${message.comment}</span></p>
          </div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="https://localhost:3001/${urlImg}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 650px;" width="650"/>
